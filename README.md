...
<a href="https://flask.palletsprojects.com"> <img src="https://flask.palletsprojects.com/en/3.0.x/_images/flask-horizontal.png" alt="Flask" style="clip-path: inset(0 0 50px 50px); width: 50px; height: 50px; object-fit: cover;"/> </a>
</p>
